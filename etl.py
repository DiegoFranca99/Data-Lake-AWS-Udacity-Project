...
def process_song_data(spark, input_data, output_data):
    "Load data from song_data dataset and extract columns for songs and artist tables and write the data into parquet files which will be loaded on s3."
...
def process_log_data(spark, input_data, output_data):
    "Load data from log_data dataset and extract columns for users and time tables, \
    reads both the log_data and song_data datasets and extracts columns for songplays table with the data.It writes the data into parquet files which will be loaded on s3."
...
def main():
    ...
    1.) Get or create a spark session wit the function.
    1.) Read the song and log data from s3 as performed above.
    2.) Transfer asn transforme the data to tables to be written to parquet files.
